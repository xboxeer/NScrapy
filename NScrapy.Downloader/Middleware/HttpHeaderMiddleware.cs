...
namespace NScrapy.Downloader.Middleware
{
    public class HttpHeaderMiddleware : EmptyDownloaderMiddleware
    {
        ...
        protected virtual void SetHeaderFromConfig(HttpClient client)
        {
            ...
            var accept = DownloaderContext.CurrentContext.CurrentConfig["AppSettings:HttpHeader:Accept"];
            ...
            var acceptEncoding= DownloaderContext.CurrentContext.CurrentConfig["AppSettings:HttpHeader:Accept-Encoding"];
            ...
            var acceptLanguage = DownloaderContext.CurrentContext.CurrentConfig["AppSettings:HttpHeader:Accept-Language"];
            ...
            var userAgent = DownloaderContext.CurrentContext.CurrentConfig["AppSettings:HttpHeader:User-Agent"];
